...
public class ProxyController {
  ...
  public ResponseEntity<?> stream(
    ...
    Token token = tsdFileAPIClient.getToken(TOKEN_TYPE, oidcType, elixirAAIIdToken);
  ...
  public void stream(
      ...
      throws IOException {
    Token token =
        tsdFileAPIClient.getToken(TOKEN_TYPE, oidcType, getElixirAAIToken(bearerAuthorization));
