...
public class Environment {
    ...
    public Environment() {
        ...
        this.egaDevBaseDirectory = env.get("E2E_EGA_DEV_BASE_DIRECTORY");
        this.egaDevPublicKeyFileName = env.get("E2E_EGA_DEV_PUBLIC_KEY_FILENAME");

        this.LSAAIToken = env.get("E2E_LSAAI_TOKEN");
    }
