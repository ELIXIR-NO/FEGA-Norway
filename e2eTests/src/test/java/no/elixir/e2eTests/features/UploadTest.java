    ...
    String token =
        (E2EState.env.getLSAAIToken() == null || E2EState.env.getLSAAIToken().isEmpty())
            ? TokenUtils.generateVisaToken(
                "upload",
                E2EState.env.getRuntime().equals("EGA_DEV") ? E2EState.env.getEgaDevJwtPubKeyPath() : "jwt.pub.pem",
                E2EState.env.getRuntime().equals("EGA_DEV") ? E2EState.env.getEgaDevJwtPrivKeyPath() : "jwt.priv.pem")
