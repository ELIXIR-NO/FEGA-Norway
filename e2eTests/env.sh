...
export E2E_PROXY_HOST=
export E2E_PROXY_PORT=
export E2E_SDA_DOA_HOST=
export E2E_SDA_DOA_PORT=
export E2E_CEGAMQ_CONN_STR=
export E2E_CEGAAUTH_USERNAME=
export E2E_CEGAAUTH_PASSWORD=
export E2E_SDA_DB_HOST=
export E2E_SDA_DB_PORT=
export E2E_SDA_DB_USERNAME=
export E2E_SDA_DB_PASSWORD=
export E2E_SDA_DB_DATABASE_NAME=
export E2E_TRUSTSTORE_PASSWORD=
export E2E_PROXY_TOKEN_AUDIENCE=
export E2E_PROXY_ADMIN_USERNAME=
export E2E_PROXY_ADMIN_PASSWORD=

# New configs introduced for EGA DEV testing
export E2E_EGA_DEV_BASE_DIRECTORY=
export E2E_EGA_DEV_PUBLIC_KEY_FILENAME=
export E2E_LSAAI_TOKEN=
